...
db = mysql.connector.connect(host="localhost",user="root",passwd="Vishal123",database="project_dbms")
mycur = db.cursor()
...
def logged():
    ...
    Label(logg, text="{} And Now You can acess this bank management system ".format(username_varify.get()), fg="green", font="bold").pack()
...
def main_screen():
    ...
    Label(root,text="Welcome to Group9",font="bold",bg="grey",fg="black",width=300).pack()
    ...
    Label(root,text="").pack()
    Label(root,text="").pack()
    Label(root,text="Developed By Group9").pack()
